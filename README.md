...
Каталог популярных VPS/VDS/cloud-провайдеров доступен выпадающим списком «Шаблон провайдера» при добавлении сервера и в форме аккаунта хостинга. Выберите хостера — панель подставит домен, ссылки на кабинет и оплату, период, валюту и подсказку, где искать ID услуги.
